# Known issues: duplicate cursor, cursor out of bound, slow cropping
...
print("[TAB] key to Start/Stop upscaling current window.\n")
...
[] modify compushady/upload2d to copy from ID3D11Texture2D/3D directly
[] modify compushady/upload2d to implement offset/stride for cropping
[] use CopySubresourceRegion((ID3D11Texture2D)) then download/upload
"""