...
def init_buffer(width, height):
    ...
    OUTPUT = Texture2D(w*2, h*2, R8G8B8A8_UNORM)
    ...
    T0 = Texture2D(w, h, R8G8B8A8_UNORM)
    T1 = Texture2D(w, h, R8G8B8A8_UNORM)
    T2 = Texture2D(w, h, R8G8B8A8_UNORM)
    T3 = Texture2D(w, h, R8G8B8A8_UNORM)
